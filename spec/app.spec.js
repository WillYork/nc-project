...
describe("/api", () => {
  ...
  describe("/articles", () => {
    describe("GET", () => {
      ...
      it("status:404 responds with an error message explaining that the article was not found", () => {
        return request(app)
    ...
    describe("PATCH", () => {
      it("status:202 should update an article's votes given the ID and respond with the updated article", () => {
        return request(app)
